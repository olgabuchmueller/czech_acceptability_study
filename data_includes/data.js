...
PennController ("demograficdata",
     newText("info", "Prosíme, vyplňte následující informace a odpovězte na otázky. Uložení a zpracování vašich odpovědí bude anonymní.")          
     ,
...
PennController("4factors",
     ...
     ,
     newScale("bildung", "Základní", "Středoškolské", "Vyšší odborné", "Vysokoškolské bakalářské","Vysokoškolské magisterské", "Vysokoškolské doktorské či vyšší")
         .settings.vertical()
         .settings.labelsPosition("right")
         .once()
     ...
     ,
     newScale("bildungPartner", "Základní", "Středoškolské", "Vyšší odborné", "Vysokoškolské bakalářské","Vysokoškolské magisterské", "Vysokoškolské doktorské či vyšší")
         .settings.vertical()
         .settings.labelsPosition("right")
         .once()
         .settings.log("bildungPartner")
     ,
     newText("beruf","<strong>Jaké je Vaše současné profesní postavení?")
     ,
     newScale("beruf","Nezaměstnaný/á", "V invalidním důchodu/práce neschopný/á", "V domácnosti", "Podnikatel/ka","Student/ka", "V důchodu", "Zaměstnaný/á")
         .settings.vertical()
         .settings.labelsPosition("right")
         .once()
         .settings.log("beruf")
     ,
     newText("berufPartner","<strong>Jaké je případně současné profesní postavení Vašeho partnera/Vaší partnerky?</strong>")
     ,
     newScale("berufPartner","Nezaměstnaný/á", "V invalidním důchodu/práce neschopný/á", "V domácnosti", "Podnikatel/ka","Student/ka", "V důchodu", "Zaměstnaný/á")
         .settings.vertical()
         .settings.labelsPosition("right")
         .once()
...
PennController("2_test"
        ...
        newCanvas(1000,100)
            ...
            .print()       
        ,
        newText("item","Píše:     Tyjo, mě to samotnýho překvapilo, no normálně se ceny zvedli.")
            .css("font-size", "large")
            .settings.center()
            .print()
        ,
...
PennController("final",
    ...
    newCanvas(1,40)
        .print()
    ,
    newText("Prosíme, poznamenejte si následující kód: <strong>Univerzita03</strong><br> Tento kód použijete, abyste získali finanční odměnu přes server Clikworker. Bez tohoto kódu není možné odměnu získat.")
        .settings.color("red")
        .css("font-size", "large")
        .settings.center()
        .print()
